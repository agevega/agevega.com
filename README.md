...
_Landing page profesional — Proyecto personal de **Alejandro Vega**._
...
_(A definir en futuras versiones)._
...
- **API Gateway** — Gestión de endpoints serverless. _(uso futuro)_
...
_(Los pasos se completarán una vez definido el stack de desarrollo)._
